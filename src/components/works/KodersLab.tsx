    ...
    >
      ...
      <ul className="mt-6 flex flex-col gap-3 hidden md:flex">
        <li className="text-base flex gap-2 text-textDark">
          ...
          Taught <strong>HTML, CSS, and JavaScript</strong> to aspiring
          developers.
        </li>
        <li className="text-base flex gap-2 text-textDark">
          <span className="text-textGreen mt-1">
          ...
          Led <strong>hands-on projects</strong> to strengthen practical coding
          skills.
        </li>
        <li className="text-base flex gap-2 text-textDark">
          <span className="text-textGreen mt-1">
          ...
          Mentored students and guided them through{" "}
